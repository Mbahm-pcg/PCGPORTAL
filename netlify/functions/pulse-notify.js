...
exports.handler = async (event) => {
  ...
  try {
    ...
    if (config.enabled === false && !isManual) {
      ...
      return isManual
        ? { statusCode: 200, headers, body: JSON.stringify({ ok: true, skipped: true, reason: 'disabled' }) }
        : undefined;
    }
    ...
    return isManual ? { statusCode: 200, headers, body: JSON.stringify(result) } : undefined;
