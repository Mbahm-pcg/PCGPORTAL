// schedule-alerts.js — Labor Schedule Risk Alerts
...
exports.handler = async (event) => {
  ...
  if (upcomingDays.length === 0) {
    return { statusCode: 200, headers, body: JSON.stringify({ ok: true, message: 'Saturday — no upcoming days to check this week' }) };
  }
