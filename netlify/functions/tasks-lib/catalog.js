...
const CATALOG = [
  ...
  t('Hot Holding', 'Hot Holding', 'Food Safety', 'temperature', { shift_time: '9 AM', allow_signoff: true, ...HOT, active: false }),
  t('Hot Holding (5 AM)', 'Hot Holding', 'Food Safety', 'temperature', { shift_time: '5 AM', allow_signoff: true, ...HOT, all45: true }),
  t('Hot Holding (9 AM)', 'Hot Holding', 'Food Safety', 'temperature', { shift_time: '9 AM', allow_signoff: true, ...HOT, all45: true }),
...
const ITEMS_CATALOG = [
  ...
  {
    namePattern: 'Food Safety Checklist (Daily)',
    items: [
      { label: 'Hand washing log confirmed', input_type: 'bool' },
      { label: 'Thermometers calibrated & available', input_type: 'bool' },
      { label: 'All food items properly labeled & dated', input_type: 'bool' },
      { label: 'FIFO rotation observed', input_type: 'bool' },
      { label: 'Food stored at correct temperatures', input_type: 'bool' },
      { label: 'Allergen awareness confirmed with crew', input_type: 'bool' },
      { label: 'No expired product on floor', input_type: 'bool' },
      { label: 'Sanitizer buckets set up & tested', input_type: 'bool' },
    ],
  },
  {
    namePattern: 'Sanitizer',
    matchType: 'prefix',
    items: [
      { label: 'Sanitizer Concentration', input_type: 'count', target: 200, min_val: 150, max_val: 400, unit: 'ppm' },
    ],
  },
  {
    namePattern: 'Walkin Cooler',
    matchType: 'prefix',
    items: [
  ...
  {
    namePattern: 'Walkin Freezer',
    matchType: 'prefix',
    items: [
      { label: 'Product Temperature', input_type: 'temperature', target: -5, min_val: -10, max_val: 0, unit: '°F' },
    ],
  },
  {
    namePattern: 'Pepsi Cooler',
    matchType: 'prefix',
    items: [
      { label: 'Product Temperature', input_type: 'temperature', target: 37, min_val: 35, max_val: 41, unit: '°F' },
    ],
    equipment: ['Pepsi Cooler 1', 'Pepsi Cooler 2'],
  },
  {
    namePattern: 'Espresso Measurements',
    items: [
      { label: 'Shot Temperature', input_type: 'temperature', target: 154, min_val: 148, max_val: 160, unit: '°F' },
      { label: 'Shot Volume (oz)', input_type: 'weight', target: 1.5, min_val: 1.3, max_val: 1.7, unit: 'oz' },
    ],
  },
  {
    namePattern: 'Backroom Checklist (Noon)',
    items: [
      { label: '3-Bay Sink set-up', input_type: 'bool' },
      { label: '3-Bay Sink sanitizer tested', input_type: 'bool' },
      { label: 'Ovens & Hoods clean', input_type: 'bool' },
      { label: 'Walk-Ins clean', input_type: 'bool' },
      { label: 'Food labeled & stored properly', input_type: 'bool' },
      { label: 'Stock Area organized', input_type: 'bool' },
      { label: 'Floors clean', input_type: 'bool' },
  ...
  {
    namePattern: 'Backroom Checklist (PM)',
    items: [
      { label: '3-Bay Sink cleaned & broken down', input_type: 'bool' },
      { label: 'Ovens & Hoods cleaned', input_type: 'bool' },
      { label: 'Walk-Ins cleaned & organized', input_type: 'bool' },
      { label: 'Food labeled & stored properly', input_type: 'bool' },
      { label: 'Floors cleaned & mopped', input_type: 'bool' },
      { label: 'Walls, Baseboards & Décor', input_type: 'bool' },
      { label: 'Back Door locked', input_type: 'bool' },
      { label: 'Cleaning Supplies restocked', input_type: 'bool' },
      { label: 'Mop Sink Area clean', input_type: 'bool' },
      { label: 'Brooms, Mops & Bucket clean', input_type: 'bool' },
    ],
  },
  {
    namePattern: 'Dining Room Checklist',
    matchType: 'prefix',
    items: [
      { label: 'Tables & chairs cleaned', input_type: 'bool' },
      { label: 'Floors clean & dry', input_type: 'bool' },
      { label: 'Trash receptacles emptied', input_type: 'bool' },
      { label: 'Windows & doors clean', input_type: 'bool' },
      { label: 'Condiment station stocked & clean', input_type: 'bool' },
      { label: 'Décor & signage in good condition', input_type: 'bool' },
    ],
  },
  {
    namePattern: 'Mens Rest Rooms Checklist',
    matchType: 'prefix',
    items: [
      { label: 'Toilet & urinal cleaned & sanitized', input_type: 'bool' },
      { label: 'Sink & faucet cleaned', input_type: 'bool' },
      { label: 'Mirror cleaned', input_type: 'bool' },
      { label: 'Paper towel & soap stocked', input_type: 'bool' },
      { label: 'Floors mopped', input_type: 'bool' },
      { label: 'Trash emptied', input_type: 'bool' },
    ],
  },
  {
    namePattern: 'Womens Rest Rooms Checklist',
    matchType: 'prefix',
    items: [
      { label: 'Toilet cleaned & sanitized', input_type: 'bool' },
      { label: 'Sink & faucet cleaned', input_type: 'bool' },
      { label: 'Mirror cleaned', input_type: 'bool' },
      { label: 'Paper towel & soap stocked', input_type: 'bool' },
      { label: 'Feminine hygiene dispenser stocked', input_type: 'bool' },
      { label: 'Floors mopped', input_type: 'bool' },
      { label: 'Trash emptied', input_type: 'bool' },
    ],
  },
  {
    namePattern: 'Unisex Rest Rooms Checklist',
    matchType: 'prefix',
    items: [
      { label: 'Toilet cleaned & sanitized', input_type: 'bool' },
      { label: 'Sink & faucet cleaned', input_type: 'bool' },
  ...
  {
    namePattern: 'Employee Rest Rooms Checklist',
    matchType: 'prefix',
    items: [
      { label: 'Toilet cleaned & sanitized', input_type: 'bool' },
      { label: 'Sink & faucet cleaned', input_type: 'bool' },
  ...
  {
    namePattern: 'Queuing Area Checklist',
    matchType: 'prefix',
    items: [
      { label: 'Menu boards & displays clean', input_type: 'bool' },
      { label: 'Counter & surfaces sanitized', input_type: 'bool' },
      { label: 'Floors clean', input_type: 'bool' },
      { label: 'Merchandise & signage in order', input_type: 'bool' },
    ],
  },
  {
    namePattern: 'Service Area Checklist',
    matchType: 'prefix',
    items: [
      { label: 'Counter & surfaces sanitized', input_type: 'bool' },
      { label: 'Equipment cleaned & organized', input_type: 'bool' },
      { label: 'Floors clean & dry', input_type: 'bool' },
      { label: 'Waste bins emptied', input_type: 'bool' },
      { label: 'All dispensers stocked', input_type: 'bool' },
    ],
  },
  {
    namePattern: 'Exterior Checklist',
    matchType: 'prefix',
    items: [
      { label: 'Parking lot clean', input_type: 'bool' },
      { label: 'Drive-thru lane clear', input_type: 'bool' },
      { label: 'Exterior windows clean', input_type: 'bool' },
      { label: 'Signage & lighting working', input_type: 'bool' },
      { label: 'Dumpster area clean & secured', input_type: 'bool' },
    ],
  },
  {
    namePattern: 'Employee Health & Wellness',
    items: [
      { label: 'All crew members in proper uniform', input_type: 'bool' },
      { label: 'No visible signs of illness in crew', input_type: 'bool' },
      { label: 'Gloves available & used when required', input_type: 'bool' },
      { label: 'Hair restraints in use', input_type: 'bool' },
    ],
  },
  {
    namePattern: 'Hot (High Volume Brewer) Calibraton',
    items: [
      { label: 'TDS Measure 1', input_type: 'count', target: 0.9, min_val: 0.8, max_val: 1.0, unit: 'TDS' },
      { label: 'TDS Measure 2', input_type: 'count', target: 0.9, min_val: 0.8, max_val: 1.0, unit: 'TDS' },
      { label: 'TDS Measure 3', input_type: 'count', target: 0.9, min_val: 0.8, max_val: 1.0, unit: 'TDS' },
      { label: 'TDS Middle', input_type: 'count', target: 0.9, min_val: 0.8, max_val: 1.0, unit: 'TDS' },
    ],
    equipment: ['Softheat Dual Brewer 1', 'Softheat Dual Brewer 2'],
  },
  {
